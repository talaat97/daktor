...
return doctorsSuccess(_that.doctorsDataList);case DoctorsError() when doctorsError != null:
...
return doctorsSuccess(_that.doctorsDataList);case DoctorsError():
return doctorsError(_that.errorHandler);case _:
  throw StateError('Unexpected subclass');
...
class DoctorsSuccess implements HomeState {
  const DoctorsSuccess(final  List<Doctors?>? doctorsDataList): _doctorsDataList = doctorsDataList;
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is DoctorsSuccess&&const DeepCollectionEquality().equals(other._doctorsDataList, _doctorsDataList));
}
...
@override
String toString() {
  return 'HomeState.doctorsSuccess(doctorsDataList: $doctorsDataList)';
}
